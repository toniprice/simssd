...
[documentation](./reference/index.html) are placeholders pending publication and
I intend to continue development when time permits.

See [Historical context](#historical-context) for background: the package began
as an implementation of
[my PhD research](https://ethos.bl.uk/concern/thesis_or_dissertations/730872)
and built on ideas from
[MLPowSim](https://www.bristol.ac.uk/cmm/software/mlpowsim/). Since then,
[the underlying research has been extended](https://doi.org/10.3102/10769986251344939);
any future development will reflect those extensions.
